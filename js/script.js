...
function addCopy(){
  ...
  var material = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load("../img/Nisrin.png"),
    transparent: true
  });
  ...
  var material = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load("../img/The.png"),
    transparent: true
  });
  var plane = new THREE.Mesh(geometry, material);
  ...
  var material = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load("../img/Best.png"),
    transparent: true
  });
  var plane = new THREE.Mesh(geometry, material);
  ...
  var material = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load("../img/Friend.png"),
    transparent: true
  });
  var plane = new THREE.Mesh(geometry, material);
